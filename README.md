...
![Build](https://github.com/rikaaa0928/plugin-test/workflows/Build/badge.svg)
...
- Manually:
  ...
  Download the [latest release](https://github.com/rikaaa0928/plugin-test/releases/latest) and install it manually using
